...
VALUES ('Bridge to Therabithia', 50, 100, '2005-03-16', '2:10', 1),
       ('Saving Private Ryan', 200, 700, '1998-07-24', '2:48', 2),
       ('Kill Bill Vol. 1', 100, 500, '2001-06-11', '2:24', 3),
       ('Kill Bill Vol. 2', 200, 700, '2003-01-24', '2:24', 3);
